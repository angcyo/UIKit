...
import com.angcyo.uiview.less.recycler.manager.ViewPagerLayoutManager;
...
public class LoopRecyclerView extends RRecyclerView {
    ...
    protected void initView(Context context) {
        ...
        new LoopSnapHelper().setOnPageListener(new RPagerSnapHelper.OnPageListener() {
            @Override
