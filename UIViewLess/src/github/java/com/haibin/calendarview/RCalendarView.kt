...
open class RCalendarView(context: Context, attributeSet: AttributeSet? = null) : CalendarView(context, attributeSet) {
    ...
    companion object {
        ...
        fun isSelectPreCalendar(delegate: CalendarViewDelegate, calendar: Calendar): Boolean {
            ...
            return delegate.mSelectedStartRangeCalendar != null && isCalendarSelected(delegate, preCalendar)
        }
        ...
        fun isSelectNextCalendar(delegate: CalendarViewDelegate, calendar: Calendar): Boolean {
            ...
            return delegate.mSelectedStartRangeCalendar != null && isCalendarSelected(delegate, nextCalendar)
        }
