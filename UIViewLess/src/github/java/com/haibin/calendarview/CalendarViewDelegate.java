...
public class CalendarViewDelegate {
    ...
    public int mCurDayTextColor,
            ...
            mCurrentMonthTextColor = 0xFF111111,
            mSelectedTextColor,
            mSelectedLunarTextColor,
            mCurMonthLunarTextColor,
            mOtherMonthLunarTextColor;
    boolean preventLongPressedSelected;
    /**
     * 日历内部左右padding
     */
    int mCalendarPadding;
    /**
     * 年视图字体大小
     */
     ...
     * 年视图月份高度和周的高度
     */
    int mYearViewMonthHeight,
            mYearViewWeekHeight;
    /**
     * 年视图一些margin和padding
     */
    int mYearViewPadding,
     ...
     * 自定义的日历路径
     */
    String mMonthViewClassPath;
    /**
     * 月视图类
     */
    Class<?> mMonthViewClass;
    /**
     * 自定义周视图路径
     */
    String mWeekViewClassPath;
    /**
     * 周视图类
     */
    Class<?> mWeekViewClass;
    /**
     * 自定义年视图路径
     */
    String mYearViewClassPath;
    /**
     * 周视图类
     */
    Class<?> mYearViewClass;
    /**
     * 自定义周栏路径
     */
    String mWeekBarClassPath;
    /**
     * 自定义周栏
     */
    Class<?> mWeekBarClass;
     ...
     */
    int mMinYearMonth, mMaxYearMonth;
    /**
     * 最小年份和最大年份对应最小天和最大天数
     * when you want set like 2015-07-08 to 2017-08-30
     */
    int mMinYearDay, mMaxYearDay;
    /**
     * 日期和农历文本大小
     */
    ...
    protected CalendarViewDelegate(Context context, @Nullable AttributeSet attrs) {
        ...
        outRangeTextColor = ResUtil.getColor(R.color.base_color_disable);
        outRangeTextLunarColor = ResUtil.getColor(R.color.base_color_disable);
    ...
    protected void init() {
        mCurrentDate = RCalendarView.Companion.today();
