 ...
 */
public final class YearViewPager extends RViewPager {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        int height = getHeight(getContext(), this);
        int measureSize = MeasureSpec.getSize(heightMeasureSpec);
        if (height > measureSize) {
            heightMeasureSpec = MeasureSpec.makeMeasureSpec(height, MeasureSpec.EXACTLY);
            super.onMeasure(widthMeasureSpec, heightMeasureSpec);
        } else {
            heightMeasureSpec = MeasureSpec.makeMeasureSpec(((View) getParent()).getMeasuredHeight(), MeasureSpec.EXACTLY);
            super.onMeasure(widthMeasureSpec, heightMeasureSpec);
        }
    }
