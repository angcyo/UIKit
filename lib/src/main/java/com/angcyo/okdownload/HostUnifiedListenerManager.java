...
public class HostUnifiedListenerManager {
    ...
    @NonNull
    public HostDownloadListener getHostListener() {
        return hostListener;
    }
    ...
    final HostDownloadListener hostListener = new HostDownloadListener();

    public class HostDownloadListener implements DownloadListener {

        public HostUnifiedListenerManager getUnifiedListenerManager() {
            return HostUnifiedListenerManager.this;
        }
