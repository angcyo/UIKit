...
//            int widthMeasureSpec = View.MeasureSpec.makeMeasureSpec(Util.getScreenWidth(mApplicationContext), View.MeasureSpec.AT_MOST);
//            int heightMeasureSpec = View.MeasureSpec.makeMeasureSpec(Util.getScreenHeight(mApplicationContext), View.MeasureSpec.AT_MOST);
...
//            mView.measure(widthMeasureSpec, heightMeasureSpec);
            ...
            return floatWindowImpl.getView();
        }
